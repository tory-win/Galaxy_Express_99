...
공개 MP4는 Range 요청에 `206 Partial Content`로 응답해 브라우저에서 재생 위치 탐색이 가능합니다. 공개 파일과 로컬 최종본의 SHA-256은 `b1af51879d7e00cb2e63de80586e4f1ce2d4ec7b68764f75a55dc9f4e5b695d6`로 일치합니다.
