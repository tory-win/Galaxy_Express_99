...
export function DisruptionScreen({ network, pool, onOpenPool, onLeave }) {
  ...
  return (
    <div className="rp-disruption-screen">
      ...
      <div className="rp-recovery-actions"><PrimaryButton onClick={onOpenPool}>현재 함께 보내기 보기</PrimaryButton><SecondaryButton onClick={onLeave}>내 운송 목록으로</SecondaryButton></div>
    </div>
  )
}
